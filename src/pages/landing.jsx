...
const LandingPage = () => {
  ...
  return (
    <div className="bg-black min-h-screen font-noto-sans-thai">
      ...
      <div id="information" className='flex flex-col py-20 items-center  justify-center sm:mx-32 sm:mt-48 sm:text-3xl lg:mt-52 xl:mt-64 lg:mx-40 xl:mx-60 lg:text-3xl xl:text-4xl '>
