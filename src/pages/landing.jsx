  ...
  return (
    <div className="bg-black min-h-screen font-kanit">
      ...
      <div id="information" className='flex flex-col py-12 items-center justify-center sm:mx-32 sm:mt-48 sm:text-2xl lg:mt-52 xl:mt-64 lg:mx-40 xl:mx-60 lg:text-2xl xl:text-3xl '>
        ...
        <button href="https://linktr.ee/epd_dmsu" className='text-xl sm:text-3xl bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl py-4 px-5'> <a href='https://linktr.ee/epd_dmsu'> สมัครเลย 🚀 </a></button>
      </div>       
    <div className='mx-12'>
      <div id="rov" style={{
