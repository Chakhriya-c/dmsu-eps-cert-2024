...
const LandingPage = () => {
  ...
  return (
    <div className="bg-black min-h-screen font-kanit">
      ...
      <div id="main_button" className='flex flex-col items-center justify-center sm:mx-10 sm:text-2xl lg:mt-1 lg:mx-40 xl:mx-60 lg:text-2xl xl:text-3xl '>
...
>        <div className='sm:order-1'>
    ...
    <div id="coverdance" style={{
              ...
              <div className='flex flex-row justify-center'>
                <img className="h-12"src="https://media.tenor.com/2l4-h42qnmcAAAAi/toothless-dancing-toothless.gif"></img>
                <img className="h-12"src="https://media.tenor.com/2l4-h42qnmcAAAAi/toothless-dancing-toothless.gif"></img>
                <img className="h-12"src="https://media.tenor.com/2l4-h42qnmcAAAAi/toothless-dancing-toothless.gif"></img>
              </div>
